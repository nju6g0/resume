...
export const slideData = [
    {
        ...
        description:
            '在片尾插畫中，展現了小月與小梅的轉變，姊妹們的媽媽從醫院康復回家後，小月褪去母職朋友們一同嬉鬧，而小梅也不再只是跟在姊姊屁股後面哭鼻子的小小孩，然而卻不見她們與龍貓的同框畫面？根劇宮崎駿(Hayao Miyazaki)本人透露，只要她們相信龍貓，她們就不會孤單，但若一直停留在那兒，她們將永遠無法回到現實世界。小月和小梅因為遇到龍貓，在找尋彼此的路上慢慢找到勇氣和希望，他表示：「從那時我們就決定不再拍續集，因為一生中只要遇過一次龍貓就夠了。」。',
        image: totoro,
    },
    {
        title: '龍貓(となりのトトロ)',
